...
export const options = buildSharedIterationsOptions(6, 18, '3m');
...
const params = scenarioParams({
  ...
  requiredMemoryMb: parseInt(__ENV.REQUIRED_MEMORY_MB || '2048', 10),
});

export default function () {
  const payload = {
    prompt: `basic-${randomSuffix()}`,
    model: params.model,
...
export function handleSummary(data) {
  return { stdout: formatSummary('Basic Concurrent Submit + Poll', data) };
}
